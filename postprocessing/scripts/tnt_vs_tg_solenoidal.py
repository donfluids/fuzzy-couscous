...
CASES = [
    ("TNT (JWL, At~0.999)", run_dir("out_tnt_chamber_128") / "tnt_chamber_128_stats.csv", "C3"),
    ("two-gamma (At~0.82)", run_dir("out_tg_chamber_128") / "tg_chamber_128_stats.csv", "C0"),
    ("single-fluid (no contact)", run_dir("out_sf_chamber_128") / "sf_chamber_128_stats.csv", "0.4"),
]
